...
patch(ListController.prototype, 'list-controller-patch', {
    ...
    async createRecord({ group } = {}) {
        ...
        if (this.editable) {
            ...
            this.orm.call("user.audit", "create_audit_log_for_create", [resModel],).then(function(data) {})
    ...
    async openRecord(record) {
        ...
        this.orm.call("user.audit", "create_audit_log_for_read", [resModel,resId],).then(function(data) {})
    },
    ...
    async onDeleteSelectedRecords() {
        ...
        const dialogProps = {
            ...
            confirm: async () => {
                ...
                this.orm.call("user.audit", "create_audit_log_for_delete", [resModel,resId],).then(function(data) {})
                this.model.notify();
                if (
                    ...
                    this.notificationService.add(
                        sprintf(
                            this.env._t(`Only the first %s records have been deleted (out of %s selected)`),
                            resIds.length,
                            total
                        ),
